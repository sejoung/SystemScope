...
describe('IPC_CHANNELS', () => {
  ...
  it('should contain all apps channels', () => {
    ...
    expect(IPC_CHANNELS.APPS_LIST_LEFTOVER_DATA).toBeDefined()
    expect(IPC_CHANNELS.APPS_REMOVE_LEFTOVER_DATA).toBeDefined()
  ...
  it('should contain all settings channels', () => {
    ...
    expect(IPC_CHANNELS.SETTINGS_GET_SYSTEM_LOG_PATH).toBeDefined()
    expect(IPC_CHANNELS.SETTINGS_GET_ACCESS_LOG_PATH).toBeDefined()
  })
