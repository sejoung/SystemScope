export const EN_MESSAGES = {
  ...
  "Review stack signals, environment files, build artifacts, Git state, and active dev servers across tracked workspaces.":
    "Review stack signals, environment files, build artifacts, Git state, and active dev servers across tracked workspaces.",
  "Stacks": "Stacks",
  "Manifests": "Manifests",
  "Env File": "Env File",
  ...
  "Unable to open the About window.": "Unable to open the About window.",
  ...
  "snapshots/growth.json — folder size snapshots for Growth View":
    "snapshots/growth.json — folder size snapshots for Growth View",
  "System Log Folder": "System Log Folder",
  "Access Log Folder": "Access Log Folder",
  ...
  "No active network interface": "No active network interface",
  ...
  "Search registry cleanup entries": "Search registry cleanup entries",
  ...
  "Removed {deletedCount} uninstall registry entrie(s), {failedCount} failed":
    "Removed {deletedCount} uninstall registry entrie(s), {failedCount} failed",
  "Loading leftover uninstall registry entries...":
    "Loading leftover uninstall registry entries...",
  ...
  "These are uninstall registry entries whose install path and uninstaller are both no longer valid. Removing them only clears the leftover uninstall registration.":
    "These are uninstall registry entries whose install path and uninstaller are both no longer valid. Removing them only clears the leftover uninstall registration.",
  "Remove Selected Registry Entries": "Remove Selected Registry Entries",
  "{count} registry entries": "{count} registry entries",
  "Registry Path": "Registry Path",
  "Install path missing": "Install path missing",
  "Uninstaller missing": "Uninstaller missing",
  "Install path unavailable": "Install path unavailable",
  "Uninstall command unavailable": "Uninstall command unavailable",
  ...
  "Unable to refresh port watch status.":
    "Unable to refresh port watch status.",
  ...
  "Unable to open the install location.":
    "Unable to open the install location.",
  "Unable to open the homepage.": "Unable to open the homepage.",
  ...
  "1 year": "1 year",
  "2 years": "2 years",
  "Unused for at least this period / 1 MB or larger":
    "Unused for at least this period / 1 MB or larger",
  ...
  "Only the selected paths will be moved to the trash together with app removal.":
    "Only the selected paths will be moved to the trash together with app removal.",
  "Searching for related data candidates.":
    "Searching for related data candidates.",
  ...
  "Moved {count} leftover data item(s) to the trash.":
    "Moved {count} leftover data item(s) to the trash.",
  ...
  "Do you want to prune the Docker build cache?":
    "Do you want to prune the Docker build cache?",
  "Currently reclaimable: {size}": "Currently reclaimable: {size}",
  Prune: "Prune",
  "Do you want to delete {count} Docker image(s)?":
    "Do you want to delete {count} Docker image(s)?",
  "Do you want to delete {count} Docker container(s)?":
    "Do you want to delete {count} Docker container(s)?",
  "Do you want to stop {count} Docker container(s)?":
    "Do you want to stop {count} Docker container(s)?",
  "Do you want to delete {count} Docker volume(s)?":
    "Do you want to delete {count} Docker volume(s)?",
  ...
  "Moved {count} leftover item(s) to the trash.":
    "Moved {count} leftover item(s) to the trash.",
  "Moved {deletedCount} leftover item(s), {failedCount} failed":
    "Moved {deletedCount} leftover item(s), {failedCount} failed",
  ...
  "timeline.events.filter.settings_change": "Settings",
  "timeline.events.filter.system": "System",
  "System Diagnosis": "System Diagnosis",
  "No issues detected. System is healthy.": "No issues detected. System is healthy.",
  Info: "Info",
  Warning: "Warning",
  Critical: "Critical",
  Evidence: "Evidence",
  ...
  "Disk Bottleneck": "Disk Bottleneck",
  "Low Disk Space": "Low Disk Space",
  "Docker Reclaimable": "Docker Reclaimable",
  "Cache Bloat": "Cache Bloat",
  "High Swap Usage": "High Swap Usage",
  "Network Saturation": "Network Saturation",
  "Last analyzed": "Last analyzed",
  "Alert Intelligence": "Alert Intelligence",
  "Sustained Alerts": "Sustained Alerts",
  "Alerts lasting more than 5 minutes": "Alerts lasting more than 5 minutes",
  "Alert Patterns": "Alert Patterns",
  "Recurring alerts in the last 24 hours": "Recurring alerts in the last 24 hours",
  "occurrences in": "occurrences in",
  "Cleanup Rules": "Cleanup Rules",
  "Configure automatic cleanup rules": "Configure automatic cleanup rules",
  "No cleanup rules configured.": "No cleanup rules configured.",
  ...
  "Docker Stopped Containers": "Docker Stopped Containers",
  "Old Log Files": "Old Log Files",
  "Temporary Files": "Temporary Files",
  "Cleanup Preview": "Cleanup Preview",
  "No items found matching your cleanup rules.": "No items found matching your cleanup rules.",
  "Total reclaimable": "Total reclaimable",
  "Scanning for cleanup targets...": "Scanning for cleanup targets...",
  "Move selected items to Trash?": "Move selected items to Trash?",
  "Cleanup completed": "Cleanup completed",
  "Some items could not be cleaned": "Some items could not be cleaned",
  "Cleanup Inbox": "Cleanup Inbox",
  "Review and approve cleanup recommendations": "Review and approve cleanup recommendations",
  "No cleanup recommendations. Your system is tidy.": "No cleanup recommendations. Your system is tidy.",
  ...
  User: "User",
  "Installed apps are sorted by name so known tools are easier to find.":
    "Installed apps are sorted by name so known tools are easier to find.",
  "Clean": "Clean",
  "No automated cleanup runs yet.": "No automated cleanup runs yet.",
  "Enable automation in Settings or run it once here to start building history.":
    "Enable automation in Settings or run it once here to start building history.",
  ...
  "Check whether local developer tools are installed and ready before you start a session.":
    "Check whether local developer tools are installed and ready before you start a session.",
  ...
  "No active development servers were detected from current listening ports.":
    "No active development servers were detected from current listening ports.",
  ...
  "Activate a workspace profile to manage tracked workspaces from DevTools.":
    "Activate a workspace profile to manage tracked workspaces from DevTools.",
  "Add Workspace": "Add Workspace",
  "Add workspace paths to the active profile to see Git insights here.":
    "Add workspace paths to the active profile to see Git insights here.",
  ...
  "You have reached the maximum number of tracked workspaces for this profile.":
    "You have reached the maximum number of tracked workspaces for this profile.",
  "{count} more workspaces are available in DevTools > Workspaces.":
    "{count} more workspaces are available in DevTools > Workspaces.",
  ...
  "Healthy": "Healthy",
  "Diagnosis Snapshot": "Diagnosis Snapshot",
  "Threshold": "Threshold",
  "Value": "Value",
  ...
  "Ports like 3000, 5173, 5432, and 8080 will appear here when occupied.":
    "Ports like 3000, 5173, 5432, and 8080 will appear here when occupied.",
  ...
  "Listening ports are prioritized first, then sorted by local port":
    "Listening ports are prioritized first, then sorted by local port",
