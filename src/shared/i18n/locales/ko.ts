export const KO_MESSAGES = {
  ...
  Developer: "개발자",
  "Open About Window": "정보 창 열기",
  "Unable to open the About window.": "정보 창을 열 수 없습니다.",
  ...
  "System Log Folder": "시스템 로그 폴더",
  "Access Log Folder": "액세스 로그 폴더",
  ...
  "Upload Speed": "업로드 속도",
  "Total Downloaded": "총 다운로드",
  "Total Uploaded": "총 업로드",
  "No active network interface": "활성 네트워크 인터페이스 없음",
  ...
  "Search registry cleanup entries": "레지스트리 정리 항목 검색",
  ...
  "Remove Selected Registry Entries": "선택한 레지스트리 항목 제거",
  "{count} registry entries": "레지스트리 항목 {count}개",
  "Registry Path": "레지스트리 경로",
  "Install path missing": "설치 경로 없음",
  "Uninstaller missing": "언인스톨러 없음",
  "Install path unavailable": "설치 경로 정보 없음",
  "Uninstall command unavailable": "언인스톨 명령 정보 없음",
  "Related Data": "관련 데이터",
  "Hide Data": "데이터 숨기기",
  ...
  "Enter a valid port, IP, or IP:Port.":
  ...
  "Unable to open the homepage.": "홈페이지를 열 수 없습니다.",
  ...
  "Invalid unsaved settings payload.":
  ...
  "Invalid minimum size. (1 KB - 1 GB)":
  ...
  "Unable to delete Docker containers.":
  ...
  "Unable to load Docker build cache.":
  ...
  "Delete {count} Docker image(s)?":
    "{count}개의 Docker 이미지를 삭제하시겠습니까?",
  "Delete Docker Containers": "Docker 컨테이너 삭제",
  "Delete {count} Docker container(s)?":
    "{count}개의 Docker 컨테이너를 삭제하시겠습니까?",
  "Stop Docker Containers": "Docker 컨테이너 중지",
  "Stop {count} Docker container(s)?":
    "{count}개의 Docker 컨테이너를 중지하시겠습니까?",
  "Delete {count} Docker volume(s)?":
    "{count}개의 Docker 볼륨을 삭제하시겠습니까?",
  "Clean Up Docker Build Cache": "Docker Build Cache 정리",
  "Do you want to clean up Docker build cache?":
    "Docker build cache를 정리하시겠습니까?",
  "Exited (stopped by SystemScope)": "Exited (SystemScope에서 중지됨)",
  "Docker Cleanup Summary": "Docker 정리 요약",
  "Docker Cleanup Summary (Partial)": "Docker 정리 요약 (일부만 로드됨)",
  ...
  workflow: "워크플로",
  partial: "일부",
  "Stopped Containers": "중지된 컨테이너",
  "Running Containers": "실행 중인 컨테이너",
  "In-use Images": "사용 중인 이미지",
  "Untagged Images (<none>)": "태그 없는 이미지 (<none>)",
  "Unused Volumes": "미사용 볼륨",
  "Clean First": "먼저 정리",
  View: "보기",
  Inspect: "확인",
  Review: "검토",
  "Recommended Flow": "추천 순서",
  "1. Clean up stopped containers": "1. 중지된 컨테이너 정리",
  "Removing {count} stopped container(s) first can release image references.":
    "중지된 컨테이너 {count}개를 먼저 제거하면 이미지 참조가 풀립니다.",
  "2. Delete unused images": "2. 사용하지 않는 이미지 삭제",
  ...
  "No issues detected. System is healthy.": "감지된 문제가 없습니다. 시스템이 정상입니다.",
  Info: "정보",
  Warning: "경고",
  Critical: "심각",
  Evidence: "근거",
  ...
  "Runaway Process": "비정상 프로세스",
  "Disk Bottleneck": "디스크 병목",
  "Low Disk Space": "디스크 공간 부족",
  "Docker Reclaimable": "Docker 회수 가능",
  "Cache Bloat": "캐시 비대",
  "High Swap Usage": "높은 스왑 사용",
  "Network Saturation": "네트워크 포화",
  "Last analyzed": "마지막 분석",
  "Alert Intelligence": "알림 인텔리전스",
  "Sustained Alerts": "지속 알림",
  "Alerts lasting more than 5 minutes": "5분 이상 지속된 알림",
  "Alert Patterns": "알림 패턴",
  "Recurring alerts in the last 24 hours": "최근 24시간 반복된 알림",
  "occurrences in": "회 발생",
  "Cleanup Rules": "정리 규칙",
  "Configure automatic cleanup rules": "자동 정리 규칙을 설정합니다",
  "No cleanup rules configured.": "설정된 정리 규칙이 없습니다.",
  "Old Downloads": "오래된 다운로드",
  "Xcode DerivedData": "Xcode DerivedData",
  "Xcode Archives": "Xcode Archives",
  "npm Cache": "npm 캐시",
  "pnpm Cache": "pnpm 캐시",
  "Yarn Cache": "Yarn 캐시",
  "Docker Stopped Containers": "Docker 중지된 컨테이너",
  "Old Log Files": "오래된 로그 파일",
  "Temporary Files": "임시 파일",
  "Cleanup Preview": "정리 미리보기",
  "No items found matching your cleanup rules.": "정리 규칙에 해당하는 항목이 없습니다.",
  "Total reclaimable": "회수 가능 용량",
  "Scanning for cleanup targets...": "정리 대상 검색 중...",
  "Move selected items to Trash?": "선택한 항목을 휴지통으로 이동하시겠습니까?",
  "Cleanup completed": "정리 완료",
  "Some items could not be cleaned": "일부 항목을 정리할 수 없습니다",
  "Cleanup Inbox": "정리 인박스",
  "Review and approve cleanup recommendations": "정리 추천 항목을 검토하고 승인합니다",
  "No cleanup recommendations. Your system is tidy.": "정리 추천 항목이 없습니다. 시스템이 깨끗합니다.",
  "Approve All": "전체 승인",
  "Safe": "안전",
  "Caution": "주의",
  "Risky": "위험",
  "Automation Schedule": "자동화 일정",
  "Enable automated scanning": "자동 스캔 활성화",
  "Scan frequency": "스캔 주기",
  "Daily": "매일",
  "Weekly": "매주",
  "Manual only": "수동",
  "Last run": "마지막 실행",
