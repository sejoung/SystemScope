...
import { runQuickScan } from '@main/services/disk'
import { getUserSpaceInfo } from '@main/services/disk'
import { findRecentGrowth, findDuplicates } from '@main/services/disk'
import { analyzeGrowth } from '@main/services/disk'
import { findOldFiles } from '@main/services/disk'
...
import { trashItemsWithConfirm } from '@main/services/core'
import { tk } from '../i18n'
