...
import { logError, logInfo, logWarn } from '@main/services/core/logging'
import { tk } from '../../i18n'
...
import { parseUninstallCommand, splitWindowsCommandArgs, buildWindowsUninstallerPowerShellCommand, sanitizeRegistryValue, pathExists, commandTargetExists, currentExeIfInside, getWindowsLeftoverGuidance } from './installedApps.windows.helpers'
...
export { parseUninstallCommand, splitWindowsCommandArgs, buildWindowsUninstallerPowerShellCommand } from './installedApps.windows.helpers'
