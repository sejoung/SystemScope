...
import { getTopCpuProcesses, getTopMemoryProcesses } from '@main/services/process/processMonitor'
import { getDiagnosisSummary } from '@main/services/diagnosis/diagnosisAdvisor'
import { getActiveAlerts } from '@main/services/alerts/alertManager'
import { getCleanupInbox } from '@main/services/cleanup/cleanupInbox'
import { listDockerImages, listDockerContainers, listDockerVolumes } from '@main/services/docker/dockerImages'
import { getTimelineData } from '@main/services/history/metricsStore'
