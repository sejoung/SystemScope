import { cardStyle, headerStyle, badgeStyle, itemContainerStyle, itemHeaderStyle, categoryBadgeStyle, expandedContentStyle, evidenceTableStyle, thStyle, tdStyle, actionButtonStyle, showAllButtonStyle } from './DiagnosisCard.styles'
